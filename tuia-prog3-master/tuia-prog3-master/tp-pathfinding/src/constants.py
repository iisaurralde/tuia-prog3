...
# Images and fonts
WEIGHT = pygame.image.load("tp-pathfinding/assets/images/weight.png")
START = pygame.image.load("tp-pathfinding/assets/images/triangle.png")
GOAL = pygame.image.load("tp-pathfinding/assets/images/circle.png")
FONT_14 = pygame.font.Font("tp-pathfinding/assets/fonts/Montserrat-Regular.ttf", 14)
FONT_18 = pygame.font.Font("tp-pathfinding/assets/fonts/Montserrat-Regular.ttf", 18)
